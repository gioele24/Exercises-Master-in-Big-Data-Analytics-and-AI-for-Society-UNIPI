...
def data_type_fix(df: pd.DataFrame, long: bool = False) -> pd.DataFrame:
    ...
    """
    This function fixes the complex data types of the datasets 'steam_games.csv'
    and 'steam_games_long.csv' (in the latter case put 'long = True'). 
    When a dataframe is exported into a csv the complex datatypes like lists 
    and dictionaries are casted into strings. This function restores the original
    data types. Moreover it converts the dates from string to a datetime object.
    """
